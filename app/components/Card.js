...
export default function Card({ icon: Icon, title, count, href }) {
    return (
        <Link href={href}>
            <div className="w-full sm:w-64 md:w-72 lg:w-90 p-6 sm:p-9 bg-white rounded-2xl border border-blue-100 shadow-sm text-center hover:shadow-xl transition-all duration-500 group cursor-pointer">
